            ...
            if(!empty($params['product_id'])){
                 ...
                 if($params['delete']){
                    ...
                    $return = 'deleted';
						...
						if(($Result['amount'] >= $params['amount']) && $Result['amount']>0){
							$return				 = db_query('UPDATE ?:user_session_products SET amount = ?i WHERE user_id = ?i AND product_id = ?i  AND type = ?s', $params['amount'], $id, $params['product_id'],  $params['type']);
							 $return 			= 'updated';
						}else{
