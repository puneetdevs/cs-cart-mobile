...
REPLACE INTO ?:discussion_messages (`message`, `post_id`, `thread_id`) VALUES('You guys have the BEST customer service known to man!!! I have always been impressed with how fast you help us out!', 18, 26);
REPLACE INTO ?:discussion_messages (`message`, `post_id`, `thread_id`) VALUES('You\'re the best! Thank you most graciously and appreciatively!', 19, 26);
...
REPLACE INTO ?:discussion_posts (`post_id`, `thread_id`, `name`, `timestamp`, `user_id`, `ip_address`, `status`) VALUES(18, 26, 'Alex', 1383914729, 0, '10.7.7.93', 'A');
REPLACE INTO ?:discussion_posts (`post_id`, `thread_id`, `name`, `timestamp`, `user_id`, `ip_address`, `status`) VALUES(19, 26, 'Michael', 1383914678, 0, '10.7.7.93', 'A');
